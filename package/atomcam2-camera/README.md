...
- **JPEG スナップショット**: `/tmp/camd.snap` を touch すると 1 枚撮って
  ...
  **解像度は H.264 側と同じフル解像度(現在 1920x1080)、ただし
  ...
  いた(実機 A/B で実証、[docs/worklog/20260806-RTSPと状態画面の競合調査.md](../../docs/worklog/20260806-RTSPと状態画面の競合調査.md))。
  ...
  (詳細は
  [docs/worklog/20260806-ISP補正情報欠落の調査.md](../../docs/worklog/20260806-ISP補正情報欠落の調査.md))。
