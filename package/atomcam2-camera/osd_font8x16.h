/* 8x16 ASCII glyphs (codepoints 32..126) extracted from the Linux kbd
 * console font default8x16.psfu (classic VGA font, public domain).
 * Each glyph is 16 rows of one byte; bit 7 is the leftmost pixel. */
static const unsigned char osd_font8x16[95][16] = {
