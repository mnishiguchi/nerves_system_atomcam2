...
> 歴史的な記録: 後の携帯アプリ試験により、`assis` を省略できるとの前提は誤りと判明した。修正後の処理構成と記憶領域の挙動は [`20260726-モバイルアプリと記録媒体の互換性.md`](20260726-モバイルアプリと記録媒体の互換性.md) に記録している。
